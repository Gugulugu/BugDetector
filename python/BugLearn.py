...
'''from tensorflow.python.keras.models import Sequential
from tensorflow.python.keras.layers import Input, Dense, Dropout, Embedding, GlobalAveragePooling1D, Attention, LayerNormalization
...
if __name__ == '__main__':
    ...
    #Transformer
    '''model.add(Input(shape=(x_length,), dtype="int32"))
